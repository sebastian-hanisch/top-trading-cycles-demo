...
gs_presets.py in gale-shapley-demo)."""
...
PRESET_KEYS = {"card": "card_select", "pref": "pref_radio", "noise": "noise_slider", "n": "n_slider", "ballung": "ballung_slider", "seed": "seed_input"}
...
KEPT = {key: f"_kept_{key}" for key in ("n_slider", "ballung_slider", "seed_input", "noise_slider")}
STEPS = {"ballung_slider": 25, "noise_slider": 5}
